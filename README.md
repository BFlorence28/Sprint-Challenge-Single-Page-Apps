...
- [x]  Explain benefit(s) using `client-side routing`? = It allows the page to not send multiple requests over and over, allowing it to load client side vs server side. (Restful API). Less server traffic/faster 
